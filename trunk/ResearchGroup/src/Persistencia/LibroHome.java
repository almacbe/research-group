...
public class LibroHome {
	...
	public void attachDirty(Libro instance) {
		log.debug("attaching dirty Libro instance");
		try {
	...
	public void attachClean(Libro instance) {
		log.debug("attaching clean Libro instance");
		try {
	...
	public void delete(Libro persistentInstance) {
		log.debug("deleting Libro instance");
		try {
	...
	public Libro merge(Libro detachedInstance) {
		...
		try {
			Libro result = (Libro) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Libro findById(int id) {
		...
		try {
			Libro instance = (Libro) sessionFactory.getCurrentSession().get(
					"Libro", id);
			if (instance == null) {
	...
	public List findByExample(Libro instance) {
		log.debug("finding Libro instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"Libro").add(Example.create(instance)).list();
