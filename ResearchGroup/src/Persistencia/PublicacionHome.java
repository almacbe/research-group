...
public class PublicacionHome {
	...
	public Publicacion merge(Publicacion detachedInstance) {
		...
		try {
			Publicacion result = (Publicacion) sessionFactory
	...
	public Publicacion findById(int id) {
		...
		try {
			Publicacion instance = (Publicacion) sessionFactory
					.getCurrentSession().get("Publicacion", id);
			if (instance == null) {
	...
	public List findByExample(Publicacion instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"Publicacion").add(Example.create(instance)).list();
